...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("CARNETSDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class CARNETSDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As CARNETSDataSet = CType(MyBase.Clone,CARNETSDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "CARNETSDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/CARNETSDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As CARNETSDataSet = New CARNETSDataSet
    ...
    Partial Public Class fotosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddfotosRow(ByVal CONTROL As Integer, ByVal FOTO() As Byte) As fotosRow
            Dim rowfotosRow As fotosRow = CType(Me.NewRow,fotosRow)
            Dim columnValuesArray() As Object = New Object() {CONTROL, FOTO}
    ...
    Partial Public Class fotosRow
        ...
        Public Property CONTROL() As Integer
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'CONTROL' de la tabla 'fotos' es DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IsCONTROLNull() As Boolean
            Return Me.IsNull(Me.tablefotos.CONTROLColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetCONTROLNull()
            Me(Me.tablefotos.CONTROLColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace CARNETSDataSetTableAdapters
    ...
    Partial Public Class fotosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[fotos] ([CONTROL], [FOTO]) VALUES (@CONTROL, @FOTO)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CONTROL, FOTO FROM dbo.fotos"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT CONTROL, FOTO FROM dbo.fotos WHERE CONTROL=@CONTROL"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CONTROL", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "CONTROL", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As CARNETSDataSet.fotosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As CARNETSDataSet.fotosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As CARNETSDataSet.fotosDataTable = New CARNETSDataSet.fotosDataTable
        ...
        Public Overloads Overridable Function FillByControl(ByVal dataTable As CARNETSDataSet.fotosDataTable, ByVal CONTROL As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (CONTROL.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(CONTROL.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function GetDataByControl(ByVal CONTROL As Global.System.Nullable(Of Integer)) As CARNETSDataSet.fotosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (CONTROL.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(CONTROL.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As CARNETSDataSet.fotosDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As CARNETSDataSet) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal CONTROL As Global.System.Nullable(Of Integer), ByVal FOTO() As Byte) As Integer
            If (CONTROL.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(CONTROL.Value,Integer)
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As CARNETSDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateInsertedRows(ByVal dataSet As CARNETSDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._fotosTableAdapter) Is Nothing) Then
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateDeletedRows(ByVal dataSet As CARNETSDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._fotosTableAdapter) Is Nothing) Then
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overridable Function UpdateAll(ByVal dataSet As CARNETSDataSet) As Integer
